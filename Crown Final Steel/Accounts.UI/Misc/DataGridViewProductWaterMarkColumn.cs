...
{
    internal class DataGridViewProductWaterMarkColumn : DataGridViewTextBoxColumn
    {
        public DataGridViewProductWaterMarkColumn()
        {
    ...
    {
         private String watermarkTextValue = "Type Here For Product Selection";
